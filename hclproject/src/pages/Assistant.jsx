    ...
    <section style={styles.shell}>
      ...
      <div style={styles.header}>
        <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "0.5rem" }}>
          <div style={styles.headerIcon}>AI</div>
          <div>
            <h3 style={styles.headerTitle}>AI Learning Assistant</h3>
              ...
              <div
                style={{
                  ...
                  background: isUser
                    ...
                    : "var(--surface-2)",
                  border: `1px solid ${isUser ? "rgba(100,108,255,0.3)" : "var(--border)"}`,
                          ...
                          <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                            {(m.payload?.practice?.flashcards || []).map((c, i) => (
                              ...
                              >
                                ...
                                <div style={{ fontSize: "0.9rem" }}>{c.back}</div>
                              </div>
                            ))}
                          </div>
                        </div>
      ...
      <div style={styles.inputArea}>
        ...
        <div style={{ display: "flex", gap: "0.75rem", alignItems: "center", flexWrap: "wrap" }}>
          ...
          <label
            ...
            title={fileLabel}
            onMouseEnter={(e) => {
              e.target.style.background = "var(--menu-item-hover)";
          ...
          <button
            ...
            style={{
              ...
              opacity: busy || (!input.trim() && files.length === 0) ? 0.6 : 1,
